...
/********************* Used wp_page_menu filter hook *********************************************/
	function edge_wp_page_menu_filter($text) {
		$replace = array(
...
add_filter('wp_page_menu', 'edge_wp_page_menu_filter');

/**************************************************************************************/
function edge_get_featured_posts() {
	return apply_filters( 'edge_get_featured_posts', array() );
}
/************ Return bool if there are featured Posts ********************************/
function edge_has_featured_posts() {
	return ! is_paged() && (bool) edge_get_featured_posts();
}
